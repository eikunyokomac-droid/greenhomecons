...
- Required runtime keys: CLOUDFLARE_EMAIL_ACCOUNT_ID, CLOUDFLARE_EMAIL_API_TOKEN (secret), CONTACT_FROM_EMAIL, CONTACT_TO_EMAIL. The account ID comes from the user's Cloudflare screenshot; never put tokens in source or client code.
